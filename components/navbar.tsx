...
export default function Navbar({ }): any {
    return (
        <nav className="fixed z-50 flex items-center justify-between w-full h-24 px-4 py-10 backdrop-blur-md bg-background bg-opacity-30 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
            <Link href="/">
                <Image alt="logo" className="w-20 cursor-pointer" src="/images/logo.svg" height={25} width={25} />
            </Link>
            ...
            <div className="items-center hidden gap-2 md:flex">
                <ModeToggle />
                <Link href="https://github.com/chaso13/convertiflo2.0">
                    <Button
                        variant="default"
                        className="items-center hidden gap-2 bg-teal-200 rounded-full w-fit md:flex"
                        size="lg"
                    >
